...
public class Application extends Controller implements IConst {
    public static String domainName = "yf-st.com";
    ...
    public static Result blankPage4Platform() {
        play.Logger.info(DateUtil.Date2Str(new Date()) + " - " + request().method() + ": " + request().uri());
        play.Logger.info(DateUtil.Date2Str(new Date()) + " - domain: " + request().host());
        if ("localhost:9002".equals(request().host())){
            play.Logger.info(DateUtil.Date2Str(new Date()) + " - " + request().host());
            return Application.homeBlPage();
        }
...
//        session("ticket", ticket);
    ...
    public static Result jianBlPage() {
        return ok(bloc_jian.render());
    }
    ...
    public static Result matrixcBlPage() {
        return ok(bloc_matrixc.render());
    }
    public static Result matrixc2BlPage() {
        return ok(bloc_matrixc2.render());
    }
    public static Result industryBlPage() {
        return ok(bloc_industry.render());
    }
    public static Result aboutBlPage() {
        return ok(bloc_about.render());
    }
