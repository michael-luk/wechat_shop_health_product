...
public class WeiXinController extends Controller implements IConst {
    ...
    // 开启开发者模式URL: /weixin/serververify
    // OAuth回调URL: yifeng.abc.com
    // JS接口安全域名: abc.com
    // 支付授权目录: http://yifeng.abc.com/wxpay/pay/
    // 支付授权测试目录: http://yifeng.abc.com/wxpaytest/pay/
    // 支付回调URL: http://yifeng.abc.com/wxpay/pay/notify/

    // abc
//    public static String wxAppId = "wx687e9ea73e290xxx";
//    public static String wxMerchantId = "1316011xxx";
//    public static String wxMerchantApiKey = "28657b8e7a98defd6347faab9d9ebxxx";
//    public static String wxSecretId = "b6781a4c31e019a6143f243514daexxx";
//    public static String wxAesKey = "QYnBBbbQhdjPAJmgDDPFyMvg9EfjYxd2lLW3z3RTxxx";
//    public static String wxTokenStr = "abcTest";

    // yifeng ori
    public static String wxAppId = "wx6352a98ae63a2d24";
    public static String wxSecretId = "5aaa78f7b115b4e506e532766c69bd11";
    public static String wxAesKey = "PbinZWTeRZGxO4POXeVMupVaj4ZVnblSi6NLAN5IsG9";
    public static String wxTokenStr = "yifengWeb";

    public static String wxMerchantId = "1262467301";
    public static String wxMerchantApiKey = "3b0d931872d6490685987ba53c80ae47";
    ...
    public static String orderNotify2Admin = "oJj7gvy6JuifAm-XyfZyPeWVoM6E,oJj7gvyIHkoC0nfGI2mmss9dzZRA";
...
//        return ok(bargain4friends.render(aid.toString()));
   ...
   /* @Security.Authenticated(Secured.class)
    ...
    public static Result addMenu() {
        ...
        button1_1.setName("逸丰简介");
        button1_1.setUrl("http://mp.weixin.qq.com/s?__biz=MzI5MjAyNTYzMw==&mid=401459816&idx=1&sn=37d990bc94678db77a0910f37df34044#rd");

        WxMenu.WxMenuButton button1_2 = new WxMenu.WxMenuButton();
        button1_2.setType("view");
        button1_2.setName("关于品牌");
        button1_2.setUrl("http://mp.weixin.qq.com/s?__biz=MzI5MjAyNTYzMw==&mid=401460382&idx=1&sn=573e9078f611955cb33ca540c34c81c1#rd");

        WxMenu.WxMenuButton button1_3 = new WxMenu.WxMenuButton();
        button1_3.setType("view");
        button1_3.setName("人物传记");
        button1_3.setUrl("http://mp.weixin.qq.com/s?__biz=MzA4NTYzNDc5MQ==&mid=401733242&idx=1&sn=57da84709b6b2d6d85c827eefb3bd118&scene=1&srcid=0304OO03Xn0jLfq1uutPAq84#wechat_redirect");
        ...
        button3_1.setName("逸丰微社区");
        button3_1.setUrl(
                "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxaaec71d24bf34f1d&redirect_uri=http%3A%2F%2Fxiaoqu.qq.com%2Fcgi-bin%2Fbar%2Fextra%2Fwx%2Fauth%3Fredirect_uri%3Dhttp%253A%252F%252Fbuluo.qq.com%252Fp%252Fbarindex.html%253Fbid%253D276567%2526from%253D&response_type=code&scope=snsapi_userinfo&state=123&connect_redirect=1#wechat_redirect");

        WxMenu.WxMenuButton button3_2 = new WxMenu.WxMenuButton();
        button3_2.setType("view");
        button3_2.setName("逸丰健康学院");
        button3_2.setUrl("http://m.wxfenxiao.com/Magazine/lists/id/2001726/sid/2007712.html");
...
//		<Event>VIEW</Event>
//		<EventKey>http://yifeng.abc.com/w/bargain</EventKey>
...
//        }
        ...
        if ("event".equals(msgType) && ("subscribe".equals(event) || "SCAN".equals(event))) {
            try {
               ...
               /* String wxMessageText = "亲，您终于来了，欢迎关注逸丰莲洲铁皮石斛官方微店，我们集铁皮石斛仿野生有机种植、加工、销售为一体，为爱健康爱生活的您提供上等的铁皮石斛产品！";
                WxMpCustomMessage wxMessage = WxMpCustomMessage.TEXT().toUser(openId).content(wxMessageText).build();*/
                WxMpCustomMessage.WxArticle article1 = new WxMpCustomMessage.WxArticle();
                article1.setUrl(
                        "http://mp.weixin.qq.com/s?__biz=MzI5MjAyNTYzMw==&mid=2649430117&idx=1&sn=c6c99318cd96a27622b64283c70208ec#rd");
                article1.setPicUrl(
                        "http://yf-st.com/showimg/images/tuisong.png");
                article1.setTitle("票选“最喜爱的月饼”，爆米花免费！免费！免费送！");
                article1.setDescription("无电影不青春！这个夏日嗨起来！");
